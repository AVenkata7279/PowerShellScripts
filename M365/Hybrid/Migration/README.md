...
**Note:** The domain (like `domain.com`), email addresses, and server names (like `server`) are placeholders and should be replaced with the correct values for your organization
